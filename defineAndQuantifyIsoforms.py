...
def define_start_end_sites(start_end_dict,start_end_dict_mono, individual_path):
    ...
    for identity in start_end_dict:
        counter += 1
        print('    processing reads assigned to spliceform ', counter, ' of ',
              number_of_isoforms, ' into isoforms', end='\r')
        starts = []
        ends = []
...
#        print('        matching reads to starts and ends')
...
#        print('        naming and writing isoform files') 
...
def main():
    ...
    start_end_dict,start_end_dict_mono = sort_reads_into_splice_junctions(splice_dict,
                                                      fasta_files, infile)
